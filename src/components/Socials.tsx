...
function Socials() {
  ...
  return (
    <motion.div
      className="fixed left-0 bottom-0 w-14  my-auto flex flex-col items-center gap-2 ml-2 z-10"
      style={{ y: y }}
    >
      <a
        ...
        className="hover:no-underline text-gray-400 dark:hover:text-gray-50 hover:text-gray-700"
      >
